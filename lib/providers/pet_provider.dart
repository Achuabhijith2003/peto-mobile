...
class PetProvider with ChangeNotifier {
  ...
  Future<void> addPet(
    ...
    try {
      ...
      final petData = {
        ...
        'imageUrl': imageUrl,
        'vaccinationHistory': [],
        'upcomingVaccinations': upcomingVaccinations.map((v) => v.toMap()).toList(),
      };
  ...
  Future<void> updatePet(Pet pet, {File? newImageFile}) async {
    ...
    try {
      ...
      final petData = {
        ...
        'imageUrl': imageUrl,
        'vaccinationHistory': updatedPet.vaccinationHistory.map((v) => v.toMap()).toList(),
        'upcomingVaccinations': updatedPet.upcomingVaccinations.map((v) => v.toMap()).toList(),
      };
  ...
  Future<void> completeVaccination(String petId, String vaccinationId) async {
    ...
    try {
      final vacIndex = pet.upcomingVaccinations.indexWhere((v) => v.id == vaccinationId);
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        List<dynamic> upcomingVaccinations = List.from(petDoc.data()!['upcomingVaccinations'] ?? []);
        List<dynamic> vaccinationHistory = List.from(petDoc.data()!['vaccinationHistory'] ?? []);
