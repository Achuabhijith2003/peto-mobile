...
class OwnerProfileScreen extends StatefulWidget {
  ...
  const OwnerProfileScreen({Key? key, this.isNewOwner = false}) : super(key: key);
                  ...
                  children: [
                    ...
                    if (_isEditing) ...[
                      ...
                      TextFormField(
                        ...
                        readOnly: true, // Email can't be changed after registration
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            widget.isNewOwner ? 'Create Profile' : 'Save Changes',
